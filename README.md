...
512-byte-headered form) and v12 through v28 releases. Older releases are
validated through the v16 through v28 intermediates.
...
V29 keeps the accepted Casey, Splinter, Shredder, and Super Shredder voices. It adds shared turtle movie calls plus voices for April, Bebop, and Leatherhead, with actor-specific voices for Slash, Krang, and Rocksteady. Stock shared short hurt grunts and April’s KO voice remain. Original music, hits, and non-vocal effects are retained; this does not claim that every generic grunt has been replaced.
...
- Full original-to-v29 and direct v28-to-v29 BPS patches, plus patcher support
  for original/headered and v12–v28 inputs.
...
Super Shredder walking poses 004/005 have the v25 204-pixel waist repair, and all twelve native biography text packets use readable TMNT presentation text. V29 voice routing preserves original music and non-vocal effects; shared short hurt grunts and April’s KO voice remain stock. Replacement music is paused and the release retains its original soundtrack. Existing title, map and geography presentation is retained. V24's localized environmental motion remains limited to the illustrated endings rather than full character cutscenes.
