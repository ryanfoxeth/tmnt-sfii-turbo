...
headered form, plus v12–v16 releases. The Python patcher validates original and v12–v15 inputs through v16 before
applying the v16-to-v17 increment; v16 inputs receive that increment directly.
The separate full original-to-v17 BPS patch is available for graphical patchers. This records the
